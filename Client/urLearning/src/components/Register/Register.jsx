...
const Register = (props) => {
  ...
  return (
    ...
    <div >{log ? <Redirect to="/" /> : <div className={s.main}>
            ...
            <form onSubmit={(e) => { handleSubmit(e) }}>
              <div className={s.email}>
                ...
                <div class="relative">
                  ...
                  <input type="text" value={inputs.email} onChange={(e) => { handleChange(e) }} name="email" id="email-address-icon" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@email.com" />
                </div>
              ...
              <div className={s.password}>
                ...
                <input type="password" value={inputs.password} onChange={(e) => { handleChange(e) }} name="password" id="password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
              ...
              <div className={s.login}>
                ...
                <br />
                <span className={s.letra}> O </span>
                <br />
                <Button className={s.change} gradientDuoTone="purpleToPink" onClick={() => setIsLoggin(!isLoggin)}>{isLoggin ? "registrar nueva cuenta" : "acceder con mis datos"}</Button>
